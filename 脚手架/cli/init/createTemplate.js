...
import { log, makeInput, makeList, getLatestVersion, request, printErrorLog } from '../utils/index.js';
    ...
    const data = [
      {
        id: 1,
        name: 'test',
        npmName: 'lzx-design-svg-icon',
        value: 'lzx-design-svg-icon',
        version: '1.0.0',
        type: 'normal',
...
export default async function createTemplate(name, opts) {
  ...
  if (addType === ADD_TYPE_PROJECT) { // 选择项目时的操作逻辑  --type project
    if (name) {
