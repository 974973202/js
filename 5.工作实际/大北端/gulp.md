...
const { nodeExternalsPlugin } = require('esbuild-node-externals'); // 将Node.js的内置模块和第三方模块排除在打包的过程之外
const { stylesImportPlugin } = require('./styles-import-plugin'); // .less文件加上?modules
